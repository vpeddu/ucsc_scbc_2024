...
![](01a_file_explorer_to_cmdline_files/images/Screen%20Shot%202022-06-28%20at%204.02.45%20PM.png){fig-align="center"}
...
![](01a_file_explorer_to_cmdline_files/images/Screen%20Shot%202022-06-28%20at%204.25.49%20PM.png){fig-align="center"}
...
![](01a_file_explorer_to_cmdline_files/images/Screen%20Shot%202022-06-28%20at%204.37.31%20PM.png){fig-align="center"}
...
![](01a_file_explorer_to_cmdline_files/images/Screen%20Shot%202022-06-28%20at%204.38.28%20PM.png){fig-align="right"}

## Practice 01B:

### Go back to Jupyter and edit README.txt to say something....

![your desktop doesn't have a text editor installed.....yet](01a_file_explorer_to_cmdline_files/images/Screen%20Shot%202022-06-28%20at%204.41.24%20PM.png){fig-align="center"}

```{bash}
mkdir SCBC_2022_folder
mkdir SCBC_2022_folder/data SCBC_2022_dir/notes SCBC_2022_folder/code
touch SCBC_2022_folder/README.txt
echo 'Hi im Roman and I like to code' > SCBC_2022_folder/README.txt
```
...
![](01a_file_explorer_to_cmdline_files/images/Screen%20Shot%202022-06-28%20at%204.38.28%20PM.png){fig-align="center"}
...
![terminal on left, file explorer on right](01a_file_explorer_to_cmdline_files/images/paste-AF551921.png){fig-align="center"}
...
![](01a_file_explorer_to_cmdline_files/images/Screen%20Shot%202022-06-30%20at%202.02.21%20PM.png){fig-align="center"}

`user` \@ `host` : `location` `$` *commands you enter here*

`user` : the name your computer calls you (we're all joyvan on PRP)
...
![](01a_file_explorer_to_cmdline_files/images/Screen%20Shot%202022-06-30%20at%201.55.51%20PM.png){fig-align="center"}
...
`pwd` : return present working directory - `pwd --help`

`ls` : list contents of directory - `ls --help`

`cd` : change directory - `cd --help`
...
grep "Roman" SCBC_2022_dir/README.txt
```

the text doesn't have to be in the beginning:

```{bash echo=TRUE}
grep "predators" SCBC_2022_dir/README.txt
```
...
`echo` : prints whatever text you want -- `echo --help`

`cat` : prints the entirety of a file (more uses soon) - `cat --help`

`grep` : finds your input text inside of a given file - `grep --help`

`rm` : irreversibly deletes files, the `-rf` flag enables recursive deletion of directories - `rm --help`

`mv` : moves a file from A to B directory - `mv --help`

`cp` : copy a file from A to B directory - `cp --help`

## A tool to bring in something new: `wget`

`wget` : "World Wide Web" + get

**Before** you run the following code, `cd` to your `SCBC_2022_dir/data` directory

```{bash echo=TRUE, eval=FALSE}
# wget [link to file]
wget 'https://raw.githubusercontent.com/rreggiar/ucsc_scbc_2022/master/data/talking.txt'
```
...
2.  What indicates that a line is a speaker vs. a statement?
3.  Print out only the speaker's names.
...
Within your `SCBC_2022_dir/data` directory, create a new file: `book_of_poems.txt` .
...
when we're done, we can share our poems/screenplays/scripts/etc.

```{bash}
# clean up working dirs
rm -rf SCBC_2022_dir
rm -rf SCBC_2022_folder
```
