...
Your Lab team has uploaded the `gene_panel_database.fa` file to your [database](https://raw.githubusercontent.com/rreggiar/ucsc_scbc_2022/master/data/gene_panel_database.fa)

-   Download `gene_panel_database.fa` to your `SCBC_2022_dir/data` directory (using the command line)
