...
However, we're going to start moving away from doing *everything* on the command line

Why do you think?

## Some formalizing and review of the Bash command line interface

Up till now, we've bee
